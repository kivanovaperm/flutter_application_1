...
class ExpenditureReportController {
  ...
  Future<List<ReportExpenditure>> reportExpenditures(
    ...
    try {
      ...
      final expendituresListJson = await _expenditureReportApi.expenditureList(
          accessToken, startDate, endDate);
      for (var element in expendituresListJson) {
        ReportExpenditure reportExpenditure =
            ReportExpenditure.fromJson(element);
